...
외국계·대기업·스타트업을 거치며 리드 개발자부터 CTO까지 다양한 역할을 수행했습니다. 웹·앱·게임·머신러닝 등 폭넓은 기술 스택을 기반으로 다양한 프로젝트의 상용화 및 글로벌 서비스 경험을 쌓았습니다. 특히 10년 이상의 스타트업 재직 및 서비스 운영 경험을 바탕으로, 단순한 개발을 넘어 기술로 비즈니스와 사용자의 문제를 해결하는 것에 큰 보람을 느낍니다.  
